...
This chain lets agents determine _not_ to build a feature when the business justification is missing — or to flag that additional business alignment should be established before taking it on.
