...
export const h001SignalNoRiskOpportunity: Rule = {
  meta: {
    ...
    docs: {
      ...
      rationale:
        "A signal that does not surface any risk or opportunity has not been analysed. An unanalysed signal breaks the context → analysis flow. Use the 'surfaces' field to document which risks and opportunities this signal reveals.",
      biz42Chapter: 2,
      recommended: true,
    },
  },
